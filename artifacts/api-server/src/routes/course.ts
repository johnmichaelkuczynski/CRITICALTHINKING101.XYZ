  ...
  try {
    generated = await chatText(
      [
        ...
        "This course is aimed at students who will have to earn their own living and make their own business decisions, so PREFER business and entrepreneurship scenarios — pricing, customers, advertising, hiring, fundraising, product and venture decisions — when you add explanation or new examples, alongside the everyday and real-world cases. Plainly hypothetical business illustrations ('Suppose a founder…') are fine, as long as you do not dress them up as real named events.",
