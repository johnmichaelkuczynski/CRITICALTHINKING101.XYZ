...
1. **`questions.ts` `violatesStandard()`** — guards only AI-*generated* questions (practice + practice-exam + diagnostics generation). Regex arrays: `LABEL_RECALL`, `CLASSIFICATION`, `DEFINITIONAL`. Necessary but NOT sufficient.
